  ...
  return (
    ...
    <div className='flex flex-col items-center '> 
     ...
     {/* All images */}
      ...
      <p className='text-base md:text-xl bg-blue-400 p-0.5 px-2 rounded-lg'>{category}</p>
      <p className='text-base md:text-xl bg-blue-400 p-0.5 px-2 rounded-lg'>{type}</p>
      </div>
